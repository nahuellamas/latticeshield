...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-407_passing-brightgreen?style=for-the-badge" alt="407 tests passing">
...
407 unit + integration tests across all four crates — all passing.
...
| 23 | Browser SDK Hardening — SRI hash auto-generated by `npm run build` (`latticeshield_bg.wasm.sha384`); TypeScript coverage added to `latticeshield-ci` skill; out-of-order `recv_seq` test (general case, recv_seq ≠ 0) added to `channel.rs`; cloud-side heartbeat signature verification spec (`latticeshield-cloud/specs/`) |
